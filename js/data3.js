...
var vopros_1 = "Осадочная горная порода, образовавшаяся в результате разрушения скальных пород в процессе выветривания и состоящая из глинистых минералов.";
var vopros_2 = "Искусственный камень правильной формы, сформированный из минеральных материалов и приобретающий камнеподобные свойства после обжига или обработки паром.";
var vopros_3 = "Основополагающий показатель. Именно он и зашифрован в марке красного кирпича под буквой F";
var vopros_4 = "Должно находиться в пределах 6—16%, если этот показатель понижается, кирпич из глины становится тяжелее, и повышается его теплопроводность";
var vopros_5 = " Какой кирпич имееет размеры 250х120х65 мм";
var pr_otv_zadachi_1 = "84A="; 
var pr_otv_zadachi_2 = "xAxH";
var pr_otv_zadachi_3 = "5Ac+Y+4+ZMIA==";
var pr_otv_zadachi_4 = "408+8+U9UuIA==";
var pr_otv_zadachi_5 = "Q4RA85";
