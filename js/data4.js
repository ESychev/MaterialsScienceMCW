...
var vopros_1 = "Какое стекло используют для остекления оконных и дверных проемов, витрин, наружной и внутренней отделки зданий.";
var vopros_2 = "Это стекло используют для уменьшения нагрева солнечными лучами и регулирования освещенности";
var vopros_3 = "Это стекло получают путем нагрева стекла до температуры закалки (540°-650°С) и последующего быстрого равномерного охлаждения";
var vopros_4 = "Это стекло получают из шихты с минимальными примесями окислов железа, титана, хрома. Увиолевое стекло пропускает 25-75% ультрафиолетовых лучей, ";
var vopros_5 = "Они состоят из двух и более стёкол, скреплённых (склеенных) между собой по контуру с помощью дистанционных рамок и герметиков.";
var pr_otv_zadachi_1 = "xB4yU="; 
var pr_otv_zadachi_2 = "ZAYw01Q==";
var pr_otv_zadachi_3 = "Q6810+Q==";
var pr_otv_zadachi_4 = "Y48141";
var pr_otv_zadachi_5 = "Y18+Q6I=";
