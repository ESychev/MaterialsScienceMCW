...
var pr_otv_zadachi_5 = "Огнеупорность";
...
if(otv_uch_1 == voprosi[0][1]){
    ...
    otveti += "<tr class='table-danger'><td>1</td><td>"+voprosi[0][0]+"</td><td>Вы ответили не верно. Ваш ответ:"+otv_ucgenika_1+" Необходимо повторить первую главу</td></tr>"; 
}
if(otv_uch_2 == voprosi[1][1]){
   ...
   otveti += "<tr class='table-danger'><td>2</td><td>"+voprosi[1][0]+"</td><td>Вы ответили не верно. Ваш ответ: "+otv_ucgenika_2+" Необходимо повторить вторую главу главу</td></tr>";  
}
if(otv_uch_3 == voprosi[2][1]){
    ...
    otveti += "<tr class='table-danger'><td>3</td><td>"+voprosi[2][0]+"</td><td>Вы ответили не верно. Ваш ответ: "+otv_ucgenika_3+" Необходимо повторить третью главу главу</td></tr>"; 
}
if(otv_uch_4 == voprosi[3][1]){
    ...
    otveti += "<tr class='table-danger'><td>4</td><td>"+voprosi[3][0]+"</td><td>Вы ответили не верно. Ваш ответ: "+otv_ucgenika_4+" Необходимо повторить четвёртую главу</td></tr>"; 
}
if(otv_uch_5 == voprosi[4][1]){
    ...
    otveti += "<tr class='table-danger'><td>5</td><td>"+voprosi[4][0]+"</td><td>Вы ответили не верно. Ваш ответ: "+otv_ucgenika_5+" Необходимо повторить пятую главу</td></tr>"; 
}
if(otv_uch_6 == voprosi[5][1]){
   ...
   otveti += "<tr class='table-danger'><td>6</td><td>"+voprosi[5][0]+"</td><td>Вы ответили не верно. Ваш ответ: "+otv_ucgenika_6+" Необходимо повторить шестую главу</td></tr>"; 
}
if(otv_uch_7 == voprosi[6][1]){
    ...
    otveti += "<tr class='table-danger'><td>7</td><td>"+voprosi[6][0]+"</td><td>Вы ответили не верно. Ваш ответ: "+otv_ucgenika_7+" Необходимо повторить седьмую главу</td></tr>"; 
}
if(otv_uch_8 == voprosi[7][1]){
    ...
    otveti += "<tr class='table-success'><td>8</td><td>"+voprosi[7][0]+"</td><td>Вы ответили верно. Ваш ответ: "+otv_ucgenika_8+"</td></tr>";
     ...
     otveti += "<tr class='table-danger'><td>8</td><td>"+voprosi[7][0]+"</td><td>Вы ответили не верно. Ваш ответ: "+otv_ucgenika_8+" Необходимо повторить восьмую главу</td></tr>";
}
if(otv_uch_9 == voprosi[8][1]){
    ...
    otveti += "<tr class='table-danger'><td>9</td><td>"+voprosi[8][0]+"</td><td>Вы ответили не верно. Ваш ответ: "+otv_ucgenika_9+" Необходимо повторить девятую главу</td></tr>";
}
if(otv_uch_10 == voprosi[9][1]){
    ...
    otveti += "<tr class='table-danger'><td>10</td><td>"+voprosi[9][0]+"</td><td>Вы ответили не верно. Ваш ответ: "+otv_ucgenika_10+" Необходимо повторить десятую главу</td></tr>";
}
if(otv_uch_11 == voprosi[10][1]){
    ...
    otveti += "<tr class='table-danger'><td>11</td><td>"+voprosi[10][0]+"</td><td>Вы ответили не верно. Ваш ответ: "+otv_ucgenika_11+" Необходимо повторить одиннадцатую главу</td></tr>";
}
if(otv_uch_12 == voprosi[11][1]){
    ...
    otveti += "<tr class='table-danger'><td>12</td><td>"+voprosi[11][0]+"</td><td>Вы ответили не верно. Ваш ответ: "+otv_ucgenika_12+" Необходимо повторить двенадцатую  главу</td></tr>";
}
