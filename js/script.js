	...
	$(window).bind('beforeprint', function qrprint(){ 
		if($("#print-qr").length == 0) {
			$('body').append(
				...
				'<p id="print-qr"><img src="https://chart.googleapis.com/chart?cht=qr&chs=200x200&choe=UTF-8&chld=H&chl=https://esychev.github.io/Diploma/index.html' + window.location.href + '"></p>'
			);
		}
	});
});
